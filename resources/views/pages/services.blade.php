            ...
            <div class="container py-lg-5 py-md-3">
                <div class="row mx-auto text-center  no-gutters">
                    <div class="col-lg-12 mt-lg-0 mt-5 text-left">
                        ...
                        <h3 class="title-w3l"><span>I'm a Passionate designer &amp; developer who loves simplicity in things
                                and crafts
                                beautiful user</span> interfaces with love.</h3>
                        <p class="mt-4 pr-lg-5">I am 29 years old front-end developer from Nowy Sacz in Poland - in the
                            busienss since 2004!

                            Through my 5 years of my career I have been working for over 500 clients from all over the
                            World. My
                            speciality is webdesign and Angular development. I guarentee great communication and quick
                            turnaround.</p>
                    </div>
                </div>
                        ...
                        <div class="pricing-body mt-4">
                            <div class="inner">
                                <ul class="list-style">
                                    ...
                                    <li><span class="fa fa-check mr-2" aria-hidden="true"></span> Database development
                                    </li>
