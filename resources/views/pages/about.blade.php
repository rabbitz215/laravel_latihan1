            ...
            <div class="container py-lg-5 py-md-4 py-2">
                <div class="row">
                    ...
                    <div class="col-lg-4 left-wthree-info px-lg-5 mt-lg-0 mt-5">
                        ...
                        <p>Pellen tesque libero ut justo, ultrices in ligula. Semper at tempufddfel. Learn more about our
                            work!
            ...
            <div class="container py-lg-5 py-md-3 py-2">
                <div class="row">
                    <div class="col-lg-6 mb-lg-0 mb-md-5 mb-5 align-self">
                        ...
                        <p class="mt-md-4 mt-3">Learn more about our work! Lorem ipsum viverra feugiat.Pellen tesque libero
                            ut
                            justo, ultrices in ligula. Semper at tempufddfel. Learn more about our work! Lorem ipsum viverra
                            feugiat.
                        </p>
                        <p class="mt-3 mb-lg-5 mb-4">Pellen tesque libero ut justo, ultrices in ligula. Semper at
                            tempufddfel. Learn
                ...
                <div class="row circle-grids">
                    ...
                    <div class="col-lg-6 position-relative pl-lg-0">
                        <div class="progress-circles">
                            <div class="circle1">
                                <div id="progress" data-dimension="160" data-text="95%" data-fontsize="32"
                                    data-percent="95" data-fgcolor="#f3525a" data-bgcolor="#eee" data-width="15"
                                    data-bordersize="5" data-animationstep="2">
                                </div>
                                <h4>HTML / CSS</h4>
                            </div>
                            <div class="circle1">
                                <div id="progress1" data-dimension="160" data-text="75%" data-fontsize="32"
                                    data-percent="75" data-fgcolor="#00d280" data-bgcolor="#eee" data-width="15"
                                    data-bordersize="5" data-animationstep="2">
                                </div>
                                <h4>PHP</h4>
                            </div>
                            <div class="circle1">
                                <div id="progress2" data-dimension="160" data-text="85%" data-fontsize="32"
                                    data-percent="85" data-fgcolor="#ffb700" data-bgcolor="#eee" data-width="15"
                                    data-bordersize="5" data-animationstep="2">
                                </div>
                                <h4>JavaScript</h4>
                            </div>
                            <div class="circle1">
                                <div id="progress3" data-dimension="160" data-text="70%" data-fontsize="32"
                                    data-percent="70" data-fgcolor="#6610f2" data-bgcolor="#eee" data-width="15"
                                    data-bordersize="5" data-animationstep="2">
                                </div>
                                <h4>Smarty / Twig</h4>
                            </div>
        ...
        <div class="container py-lg-5 py-md-4">
            <div class="welcome-left text-center">
                ...
                <h3 class="title-w3l mb-4 mx-0 mw-100"> <span>I Can give your business a new Creative </span>
                    start right away!</h3>
                <p class="pr-lg-5">Lorem ipsum viverra feugiat. Pellen tesque libero ut justo, ultrices in ligula. Semper
                    at
